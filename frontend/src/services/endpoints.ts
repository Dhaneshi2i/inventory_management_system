...
export const apiEndpoints = {
  ...
  inventory: {
    ...
    getLowStock: (params?: any) => apiService.get<ApiResponse<Inventory>>('/inventory/low-stock/', { params }),
    getOutOfStock: (params?: any) => apiService.get<ApiResponse<Inventory>>('/inventory/out-of-stock/', { params }),
  },
  ...
  // Purchase Orders
  purchaseOrders: {
    getAll: (params?: PurchaseOrderFilters) => apiService.get<ApiResponse<PurchaseOrder>>('/purchase-orders/', { params }),
  ...
  dashboard: {
    ...
    getLowStock: (params?: any) => apiService.get<ApiResponse<Inventory>>('/dashboard/low-stock/', { params }),
    getRecentMovements: (params?: any) => apiService.get<ApiResponse<StockMovement>>('/dashboard/recent-movements/', { params }),
    getPendingOrders: (params?: any) => apiService.get<ApiResponse<PurchaseOrder>>('/dashboard/pending-orders/', { params }),
